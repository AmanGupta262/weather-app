      ...
      <div className={classes.dFlex}>
        ...
        <div className="weather d-flex">
          <div className="temperature d-flex">
            ...
            <div className="curr-temperature">{currentWeather.temp}&deg;</div>
          </div>
        ...
        <div className="details-container d-flex">
          ...
          <div className="details d-flex">
            ...
            <div className="detail d-flex">
              ...
              <div className="detail-data">{currentWeather.wind_speed} Km/h</div>
            </div>
            <div className="detail d-flex">
              <img
                className="detail-icon"
            ...
            <div className="detail d-flex">
              ...
              <div className="detail-data">{currentWeather.pressure} mb</div>
            </div>
          </div>
        </div>
      </div>
